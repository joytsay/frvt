...
#  define FACEDETECTION_DEPRECATED_EXPORT FACEDETECTION_EXPORT __attribute__ ((__deprecated__))
#  define FACEDETECTION_DEPRECATED_NO_EXPORT FACEDETECTION_NO_EXPORT __attribute__ ((__deprecated__))
#endif
